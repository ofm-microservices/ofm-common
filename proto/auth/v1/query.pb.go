...
const file_auth_v1_query_proto_rawDesc = "" +
	...
	"\x1aDeactivateRegistrationAuth\x12*.auth.v1.DeactivateRegistrationAuthRequest\x1a+.auth.v1.DeactivateRegistrationAuthResponseB?Z=github.com/ofm-microseervices/ofm-common/proto/auth/v1;authv1b\x06proto3"
