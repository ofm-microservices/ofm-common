...
func (UnimplementedPaymentOnboardingServiceServer) StartFreelancerOnboarding(context.Context, *StartFreelancerOnboardingRequest) (*StartFreelancerOnboardingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartFreelancerOnboarding not implemented")
}
func (UnimplementedPaymentOnboardingServiceServer) GetConnectStatus(context.Context, *GetConnectStatusRequest) (*GetConnectStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConnectStatus not implemented")
}
...
func RegisterPaymentOnboardingServiceServer(s grpc.ServiceRegistrar, srv PaymentOnboardingServiceServer) {
	// If the following call panics, it indicates UnimplementedPaymentOnboardingServiceServer was
