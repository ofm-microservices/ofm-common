...
func (noopMeter) ObserveCircuitBreaker(string, string)                               {}
...
func (noopMeter) IncKafkaReceived(string)                                            {}
func (noopMeter) ObserveKafkaProcessed(string, string, time.Duration)                {}
func (noopMeter) IncKafkaRetry(string)                                               {}
func (noopMeter) IncKafkaError(string)                                               {}
